...
function StartRush() {
  ...
  return (
    ...
    max-w-full  h-[calc(100vh-10vh)] bg-no-repeat bg-center bg-cover select-none "
      style={{ backgroundImage: "url(https://d3g74fig38xwgn.cloudfront.net/sound_wall/images/rocketRushBg.png)" }}
      draggable={false}
    >
      {showRush ? (
        <SelectionPage />
        ...
        >
          ...
          /> */}
           <img
            ...
            className="hidden lg:block h-full lg:h-auto"
            draggable={false}
          ...
          />
          <div className=" w-[50%] absolute flex justify-start items-start flex-col gap-[1rem]">
  ...
  >
    <img src="https://d3g74fig38xwgn.cloudfront.net/sound_wall/images/FirstRocketPoint.png" className="h-[5rem]" draggable={false} />
  </motion.div>
  ...
  >
    <img src="https://d3g74fig38xwgn.cloudfront.net/sound_wall/images/secondRocketPoint.png" className="h-[5rem]" draggable={false} />
  </motion.div>
  ...
  >
    <img src="https://d3g74fig38xwgn.cloudfront.net/sound_wall/images/ThirdRocketPoint.png" className="h-[5rem]" draggable={false} />
  </motion.div>
